...
// renders all baby names
render(BABYNAMES);

// renders only females from 0 - 100
// render(females.slice(0,100));

var searchInput = document.getElementById("name-search-input");
// allows us to name an event we are listening for, linked to a function, which will be called each time
// the event occured. 
