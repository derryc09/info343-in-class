...
function render(state){
    ...
    //render the paddle
    ctx.fillRect(state.paddle.x, state.paddle.y,
        state.paddle.width, state.paddle.height);
}

//step and then render
function animate(timestamp){
    //step the animation and keep goin
...
function startGame(){
    gameState = {
      ball: {
          ...
          vectorX: 1,
          vectorY: 1,
          velocity: 3, //how many pixels the ball travels in a given step. 
